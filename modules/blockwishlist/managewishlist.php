	...
	if (empty($id_wishlist) === false)
	{
		...
		else
		{
			if (!strcmp($action, 'delete'))
				WishList::removeProduct($id_wishlist, (int)$context->cookie->id_customer_wish, $id_product, $id_product_attribute);

			$products = WishList::getProductByIdCustomer($id_wishlist, $context->cookie->id_customer_wish, $context->language->id);
			...
			$context->smarty->assign(array(
					...
					'wishlists' => WishList::getByIdCustomer($context->cookie->id_customer_wish)
				));
