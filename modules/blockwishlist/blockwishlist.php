...
{	
    ...
    public function hookDisplayProductListFunctionalButtons($params) {
        ...
        if ($this->context->cookie->id_customer_wish)
            $this->smarty->assign('wishlists', Wishlist::getByIdCustomer($this->context->cookie->id_customer_wish));
    ...
    public function hookTop($params) {
        if ($this->context->cookie->id_customer_wish) {
            $wishlists = Wishlist::getByIdCustomer($this->context->cookie->id_customer_wish);
            if (empty($this->context->cookie->id_wishlist) === true ||
                    WishList::exists($this->context->cookie->id_wishlist, $this->context->cookie->id_customer_wish) === false) {
                if (!count($wishlists))
                    $id_wishlist = false;
                else {
            ...
            $this->smarty->assign(
                    array(
                        ...
                        'isLogged' => true,
                        'wishlist_products' => ($id_wishlist == false ? false : WishList::getProductByIdCustomer($id_wishlist, $this->context->cookie->id_customer_wish, $this->context->language->id, null, true)),
                        'wishlists' => $wishlists,
    ...
    public function hookProductActions($params) {
        ...
        if (isset($this->context->cookie->id_customer_wish))
            $this->smarty->assign(array(
                'wishlists' => WishList::getByIdCustomer($this->context->cookie->id_customer_wish),
            ));
