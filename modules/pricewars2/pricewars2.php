 ...
 * Utworzono  : 2020-03-18 12:04:21
 * Author     : SEIGI - Grzegorz Zawadzki <kontakt@seigi.eu>
 */

if(Configuration::get('SEI_BLOCK_pricewars2') == 1 ||  !extension_loaded('ionCube Loader') || ioncube_loader_iversion() < 100202 || PHP_VERSION_ID < 50600 || PHP_VERSION_ID > 70399){
	...
	class pricewars2 extends Module {
		public function __construct()
		{
			...
			parent::__construct();
			$this->displayName = $this->l( 'pricewars2' );
		...
		public function install() {
			...
			Configuration::updateGlobalValue('SEI_BLOCK_pricewars2', 1);
			return parent::install();
		}
		public function uninstall() {
			Configuration::deleteByName('SEI_BLOCK_pricewars2');
