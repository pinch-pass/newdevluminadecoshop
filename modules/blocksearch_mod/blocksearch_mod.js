                    ...
                    for (var i = 0; i < data.length; i++){
                        if(i==3){
                            ...
                            if(PS_CATALOG_MODE)
                                ...
                                mytab[mytab.length] = { data: data[i], value:  '<div class="row"><div class="col-xs-3 ac_photo"><img class="img-responsive" src="'+ data[i].obr_thumb + '" /></div><div class="col-xs-9 ac_name"><div class="nameref"><p class="reference product-reference">Артикул: ' + data[i].preference + '</p><p class="prname">'  + data[i].pname + ' </p></div><span class="price product-price">'+ data[i].product_price +'</span></div></div>'};
