...
abstract class AbstractOffer implements OfferInterface
{
    ...
    private function getHeaderOptions()
    {
        return [
            ...
            'cartons_dimensions' => $this->getCartonsDimensions(),
            'cartons_dimensions_1' => $this->getCartonsDimensions1(),
            'cartons_dimensions_2' => $this->getCartonsDimensions2(),
    ...
    private $cartons_dimensions;
    private $cartons_dimensions_1;
    private $cartons_dimensions_2;
    private $volume;
    private $assembly = true;

    function getCartonsDimensions()
    {
        return $this->cartons_dimensions;
    }

    function setCartonsDimensions($cartons_dimensions)
    {
        $this->cartons_dimensions = $cartons_dimensions;
        return $this;
    }
    function getCartonsDimensions1()
    {
        return $this->cartons_dimensions_1;
    }

    function setCartonsDimensions1($cartons_dimensions)
    {
        $this->cartons_dimensions_1 = $cartons_dimensions;
        return $this;
    }
    function getCartonsDimensions2()
    {
        return $this->cartons_dimensions_2;
    }

    function setCartonsDimensions2($cartons_dimensions)
    {
        $this->cartons_dimensions_2 = $cartons_dimensions;
        return $this;
    }
