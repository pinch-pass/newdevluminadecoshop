...
class RevwsReview extends ObjectModel {
  ...
  public static $definition = [
    ...
    'fields'  => [
      ...
      'advantages'     => [ 'type' => self::TYPE_STRING, 'size' => 65535, 'required' => true],
      'disadvantages'  => [ 'type' => self::TYPE_STRING, 'size' => 65535],
  ...
  private static function mapDbData($dbData) {
    ...
    $review->advantages = empty($dbData['advantages']) ? '' : $dbData['advantages'];
    $review->disadvantages = empty($dbData['disadvantages']) ? '' : $dbData['disadvantages'];
  ...
  public static function fromRequest(Visitor $visitor) {
    ...
    $review->advantages = Tools::getValue('advantages');
    $review->disadvantages = Tools::getValue('disadvantages');
  ...
  public static function fromJson($json, $settings) {
    ...
    $review->advantages = $json['advantages'];
    $review->disadvantages = $json['disadvantages'];
