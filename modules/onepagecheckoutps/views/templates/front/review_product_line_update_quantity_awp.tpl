...
<div id="cart_quantity_button" class="cart_quantity_button">
    <input
        ...
        value="{if $quantityDisplayed == 0 AND isset($customizedDatas.$productId.$productAttributeId)}{$customizedDatas.$productId.$productAttributeId|@count}{else}{$product_quantity|floatval}{/if}"
        name="quantity_{$product.id_product|intval}_{$product.id_product_attribute|intval}_{$id_customization|intval}_{$product.instructions_valid|escape:'html':'UTF-8'}_{$product.id_address_delivery|intval}_hidden"
    />
    <div class="row col-xs-12 nopadding pts-vcenter">
        <div class="input-group input-group-sm">
            <span class="input-group-btn">
                <button
                    id="cart_quantity_down_{$product.id_product|intval}_{$product.id_product_attribute|intval}_{$id_customization|intval}_{$product.instructions_valid|escape:'html':'UTF-8'}_{$product.id_address_delivery|intval}"
                    type="button"
            ...
            <span class="input-group-btn">
                {if isset($customizedDatas.$productId.$productAttributeId)}
                    <a class="btn-number cart_quantity_delete"
                       id="{$product.id_product|intval}_{$product.id_product_attribute|intval}_{$id_customization|intval}_{$product.instructions_valid|escape:'html':'UTF-8'}_{$product.id_address_delivery|intval}"
