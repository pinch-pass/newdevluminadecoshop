...
<div id="pts_content" class="pts bootstrap nopadding clear clearfix">
    ...
    {*endRemoveIf(addons)*}
        <div class="row">
            ...
            {/if}
            <div class="clear row-fluid clearfix col-xs-12 nopadding-xs">
                                                ...
                                                <div class="panel clearfix panel-primary">
                                                    <div class="panel-heading">
                                                        <span class="panel-title">
                                                            <i class='fa-pts fa-pts-truck fa-pts-1x nohover'></i>&nbsp;{$carrier.name|escape:'htmlall':'UTF-8'}
                                                        </span>
                                                    </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-xs-12 col-md-9 pts-image-change-container">
                                                                                ...
                                                                                <img class="img-thumbnail" id="image_payment_{$payment.name|escape:'htmlall':'UTF-8'}" height="49" width="86"
                                                                                    src="{if file_exists($filename)}{$paramsBack.MODULE_IMG|cat:'payments/'|cat:$payment.name_image}{else}{$filename_default|escape:'htmlall':'UTF-8'}{/if}?{$smarty.now|escape:'htmlall':'UTF-8'}" />
                                                                                <br />
