...
*/
    ...
    //Modificado por PresTeamShop.com
    //-------------------------------
    var $url_encode = true;
    //-------------------------------
    ...
    Function GetDialogURL(&$url, $redirect_uri = '', $state = '')
    {
        ...
        if ($this->url_encode) {
            ...
            $url = str_replace(
                '{NONCE}', (uniqid($state)), str_replace(
                '{REDIRECT_URI}', ($redirect_uri), str_replace(
                '{STATE}', ($state), str_replace(
                '{CLIENT_ID}', ($this->client_id), str_replace(
                '{API_KEY}', ($this->api_key), str_replace(
...
<?php
                if (strlen($this->access_token_expiry)) {
                    ?>
<p>Access token expiry: <?php echo $this->access_token_expiry;
                    ?> UTC</p>
<?php
