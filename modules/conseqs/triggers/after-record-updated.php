...
class AfterRecordUpdated extends Trigger
{
    ...
    {
        return $this->l('After record has been updated');
    }
    ...
    {
        return $this->l('This hook is called after record has been updated and saved into database');
    }
    ...
    public function register($id, ParameterValues $settings, RulesManager $manager)
    {
        ...
        $manager->registerHook('actionObject' . $recordType . 'UpdateAfter');
    }
