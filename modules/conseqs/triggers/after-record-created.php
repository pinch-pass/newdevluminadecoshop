...
class AfterRecordCreated extends Trigger
{
    ...
    {
        return $this->l('After record has been created');
    }
    ...
    {
        return $this->l('This hook is called after new record has been created and saved into database');
    }
    ...
    public function register($id, ParameterValues $settings, RulesManager $manager)
    {
        ...
        $manager->registerHook('actionObject' . $recordType . 'AddAfter');
    }
