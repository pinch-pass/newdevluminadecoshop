...
class MetaCore extends ObjectModel
{
    ...
    public static function getProductMetas($id_product, $id_lang, $page_name)
    {
        ...
        if ($row = Db::getInstance(_PS_USE_SQL_SLAVE_)->getRow($sql)) {
			...
			$row['meta_title'] = $row['name'] . ' купить в Москве - Lumina Deco';
			
			$row['meta_description'] = $row['name'] . ' в интернет-магазине Lumina Deco по выгодной цене в Москве с доставкой по России. Эксклюзивные модели, польское качество.';
