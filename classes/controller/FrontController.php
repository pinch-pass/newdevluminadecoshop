...
class FrontControllerCore extends Controller
{
    ...
    public function init()
    {
		...
		if($page_name == 'category') {
			//$canonical2 = $this->context->link->getCategoryLink($this->category);
			$canonical2 = $link->getPaginationLink(false, false, false, true);
		}
    ...
    public function pagination($total_products = null)
    {
        ...
        if ((int)$n_array[2] < $total_products && (int)$total_products > 0) {
            $n_array['all'] = (int)$total_products;
        }
