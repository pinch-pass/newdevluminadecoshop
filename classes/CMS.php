...
class CMSCore extends ObjectModel
{
    ...
    public static $definition = array(
        ...
        'fields' => array(
            ...
            'page_title' =>            array('type' => self::TYPE_STRING, 'lang' => true, 'validate' => 'isGenericName', 'required' => true, 'size' => 255),
    ...
    public static function getLinks($id_lang, $selection = null, $active = true, Link $link = null)
    {
		...
		SELECT c.id_cms, cl.link_rewrite, cl.meta_title, cl.page_title
