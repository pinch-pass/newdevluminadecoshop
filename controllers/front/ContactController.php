    ...
    */
    public function postProcess()
    {
        if (Tools::isSubmit('submitMessage')) {
            ...
            if (!($from = trim(Tools::getValue('from'))) || !Validate::isEmail($from)) {
            ...
            } elseif (!($id_contact = Tools::getValue('id_contact')) || !(Validate::isLoadedObject($contact = new Contact($id_contact, $this->context->language->id)))) {
                ...
                if (!count($this->errors)) {
                   ...
                   $subject = Tools::getValue('subject');
					if (!Mail::Send( // mail do LuminaDeco
						$this->context->language->id,
						'contact',
						Mail::l('Wiadomość od klienta').": ". $subject,
						$var_list,
						$contact->email, // TO
						$contact->name,
						null,
						...
						null,
						$from // reply-to
					)  || !Mail::Send($this->context->language->id, // Kopia do Klienta
						'contact_form',
