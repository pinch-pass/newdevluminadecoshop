...
class CmsControllerCore extends FrontController
{
	...
	public function setMedia()
	{
		...
		$this->addCSS(_THEME_JS_DIR_.'slick/slick.css');
		$this->addJS(_THEME_JS_DIR_.'slick/slick.min.js');
		
		$this->addCSS(_THEME_CSS_DIR_.'cms.css');
		$this->addJqueryPlugin(array('fancybox', 'idTabs', 'scrollTo', 'serialScroll', 'bxslider', 'cocoen'));
	...
	public function initContent()
	{
		...
		if ($this->assignCase == 1)
		{
			...
			$this->context->smarty->assign(array(
				...
				// add				
				// 'our_works' => CMS::getCMSPages($this->context->language->id, 3)
				//end add
			));
...
// if($this->cms && $this->cms->id_cms_category == 3){
// 	        $url_corrector = $this->context->link->getCMSLink($this->cms, $this->cms->link_rewrite, $this->ssl);
// 	        $this->context->smarty->assign(array(
