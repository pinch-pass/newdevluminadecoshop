...
class AdminStoresControllerCore extends AdminController
{
    ...
    public function renderForm()
    {
        ...
        $image_1 = _PS_STORE_IMG_DIR_.$obj->id.'.jpg';
        $image_url_1 = ImageManager::thumbnail($image_1, $this->table.'_'.(int)$obj->id.'.'.$this->imageType, 350,
            $this->imageType, true, true);
        $image_size_1 = file_exists($image_1) ? filesize($image_1) / 1000 : false;

        $image_2 = _PS_STORE_IMG_DIR_.$obj->id.'.jpg';
        $image_url_2 = ImageManager::thumbnail($image_2, $this->table.'_'.(int)$obj->id.'.'.$this->imageType, 350,
            $this->imageType, true, true);
            $image_size_2 = file_exists($image_2) ? filesize($image_2) / 1000 : false;
          
        $image_3 = _PS_STORE_IMG_DIR_.$obj->id.'.jpg';
        $image_url_3 = ImageManager::thumbnail($image_3, $this->table.'_'.(int)$obj->id.'.'.$this->imageType, 350,
            $this->imageType, true, true);
            $image_size_3 = file_exists($image_3) ? filesize($image_3) / 1000 : false;
        
        $image_4 = _PS_STORE_IMG_DIR_.$obj->id.'.jpg';
        $image_url_4 = ImageManager::thumbnail($image_4, $this->table.'_'.(int)$obj->id.'.'.$this->imageType, 350,
            $this->imageType, true, true);
            $image_size_4 = file_exists($image_4) ? filesize($image_4) / 1000 : false;
        
        $image_5 = _PS_STORE_IMG_DIR_.$obj->id.'.jpg';
        $image_url_5 = ImageManager::thumbnail($image_5, $this->table.'_'.(int)$obj->id.'.'.$this->imageType, 350,
            $this->imageType, true, true);
            $image_size_5 = file_exists($image_5) ? filesize($image_5) / 1000 : false;
           
        $image_6 = _PS_STORE_IMG_DIR_.$obj->id.'.jpg';
        $image_url_6 = ImageManager::thumbnail($image_6, $this->table.'_'.(int)$obj->id.'.'.$this->imageType, 350,
            $this->imageType, true, true);
            $image_size_6 = file_exists($image_6) ? filesize($image_6) / 1000 : false;
          
        $image_7 = _PS_STORE_IMG_DIR_.$obj->id.'.jpg';
        $image_url_7 = ImageManager::thumbnail($image_7, $this->table.'_'.(int)$obj->id.'.'.$this->imageType, 350,
            $this->imageType, true, true);
            $image_size_7 = file_exists($image_7) ? filesize($image_7) / 1000 : false;
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    'type' => 'text',
                    'label' => $this->l('Route Link'),
                    'name' => 'address2'
                ),
                // array(
                //     'type' => 'text',
                //     'label' => $this->l('Store Page Link'),
                //     'name' => 'postcode',
                ...
                array(
                    ...
                    'name' => 'image_1',
                    'display_image' => true,
                    'image' => $image_url_1 ? $image_url_1 : false,
                    'size' => $image_size_1,
                    'hint' => $this->l('Storefront picture.')
                ),
                array(
                    ...
                    'name' => 'image_2',
                    'display_image' => true,
                    'image' => $image_url_2 ? $image_url_2 : false,
                    'size' => $image_size_2,
                    'hint' => $this->l('Storefront picture.')
                ),
                array(
                    ...
                    'name' => 'image_3',
                    'display_image' => true,
                    'image' => $image_url_3 ? $image_url_3 : false,
                    'size' => $image_size_3,
                    'hint' => $this->l('Storefront picture.')
                ),
                array(
                    'type' => 'file',
                    'label' => $this->l('Picture 4'),
                    'name' => 'image_4',
                    'display_image' => true,
                    'image' => $image_url_4 ? $image_url_4 : false,
                    'size' => $image_size_4,
                    'hint' => $this->l('Storefront picture.')
                ),
                array(
                    'type' => 'file',
                    'label' => $this->l('Picture 5'),
                    'name' => 'image_5',
                    'display_image' => true,
                    'image' => $image_url_5 ? $image_url_5 : false,
                    'size' => $image_size_5,
                    'hint' => $this->l('Storefront picture.')
                ),
                array(
                    'type' => 'file',
                    'label' => $this->l('Picture 6'),
                    'name' => 'image_6',
                    'display_image' => true,
                    'image' => $image_url_6 ? $image_url_6 : false,
                    'size' => $image_size_6,
                    'hint' => $this->l('Storefront picture.')
                ),
                array(
                    'type' => 'file',
                    'label' => $this->l('Picture 7'),
                    'name' => 'image_7',
                    'display_image' => true,
                    'image' => $image_url_7 ? $image_url_7 : false,
                    'size' => $image_size_7,
                    'hint' => $this->l('Storefront picture.')
                )
            ),
    ...
    protected function postImage($id)
    {
        ...
        $ret2 = $this->uploadImage($id.'_1', 'image_1', $this->fieldImageSettings['dir'].'/');
        if (($id_store = (int)Tools::getValue('$id_store')) && isset($_FILES) && count($_FILES) && $_FILES['image_1']['name'] != null && file_exists(_PS_STORE_IMG_DIR_.$id_store.'_1.jpg')) {
            $images_types = ImageType::getImagesTypes('stores');
            foreach ($images_types as $k => $image_type)
            {   
                ImageManager::resize(_PS_STORE_IMG_DIR_.$id_store.'_1.jpg',
                    _PS_STORE_IMG_DIR_.$id_store.'_1-'.stripslashes($image_type['name']).'.jpg',
                    (int)$image_type['width'], (int)$image_type['height']
                );
        ...
        $ret3 = $this->uploadImage($id.'_2', 'image_2', $this->fieldImageSettings['dir'].'/');
        if (($id_store = (int)Tools::getValue('$id_store')) && isset($_FILES) && count($_FILES) && $_FILES['image_2']['name'] != null && file_exists(_PS_STORE_IMG_DIR_.$id_store.'_2.jpg')) {
            $images_types = ImageType::getImagesTypes('stores');
            foreach ($images_types as $k => $image_type)
            {   
                ImageManager::resize(_PS_STORE_IMG_DIR_.$id_store.'_2.jpg',
                    _PS_STORE_IMG_DIR_.$id_store.'_2-'.stripslashes($image_type['name']).'.jpg',
                    (int)$image_type['width'], (int)$image_type['height']
                );
        ...
        $ret4 = $this->uploadImage($id.'_3', 'image_3', $this->fieldImageSettings['dir'].'/');
        if (($id_store = (int)Tools::getValue('$id_store')) && isset($_FILES) && count($_FILES) && $_FILES['image_3']['name'] != null && file_exists(_PS_STORE_IMG_DIR_.$id_store.'_3.jpg')) {
            $images_types = ImageType::getImagesTypes('stores');
            foreach ($images_types as $k => $image_type)
            {   
                ImageManager::resize(_PS_STORE_IMG_DIR_.$id_store.'_3.jpg',
                    _PS_STORE_IMG_DIR_.$id_store.'_3-'.stripslashes($image_type['name']).'.jpg',
                    (int)$image_type['width'], (int)$image_type['height']
                );

            }
        }
        $ret5 = $this->uploadImage($id.'_4', 'image_4', $this->fieldImageSettings['dir'].'/');
        if (($id_store = (int)Tools::getValue('$id_store')) && isset($_FILES) && count($_FILES) && $_FILES['image_4']['name'] != null && file_exists(_PS_STORE_IMG_DIR_.$id_store.'_4.jpg')) {
            $images_types = ImageType::getImagesTypes('stores');
            foreach ($images_types as $k => $image_type)
            {   
                ImageManager::resize(_PS_STORE_IMG_DIR_.$id_store.'_4.jpg',
                    _PS_STORE_IMG_DIR_.$id_store.'_4-'.stripslashes($image_type['name']).'.jpg',
                    (int)$image_type['width'], (int)$image_type['height']
                );

            }
        }
        $ret6 = $this->uploadImage($id.'_5', 'image_5', $this->fieldImageSettings['dir'].'/');
        if (($id_store = (int)Tools::getValue('$id_store')) && isset($_FILES) && count($_FILES) && $_FILES['image_5']['name'] != null && file_exists(_PS_STORE_IMG_DIR_.$id_store.'_5.jpg')) {
            $images_types = ImageType::getImagesTypes('stores');
            foreach ($images_types as $k => $image_type)
            {   
                ImageManager::resize(_PS_STORE_IMG_DIR_.$id_store.'_5.jpg',
                    _PS_STORE_IMG_DIR_.$id_store.'_5-'.stripslashes($image_type['name']).'.jpg',
                    (int)$image_type['width'], (int)$image_type['height']
                );

            }
        }
        $ret7 = $this->uploadImage($id.'_6', 'image_6', $this->fieldImageSettings['dir'].'/');
        if (($id_store = (int)Tools::getValue('$id_store')) && isset($_FILES) && count($_FILES) && $_FILES['image_6']['name'] != null && file_exists(_PS_STORE_IMG_DIR_.$id_store.'_6.jpg')) {
            $images_types = ImageType::getImagesTypes('stores');
            foreach ($images_types as $k => $image_type)
            {   
                ImageManager::resize(_PS_STORE_IMG_DIR_.$id_store.'_6.jpg',
                    _PS_STORE_IMG_DIR_.$id_store.'_6-'.stripslashes($image_type['name']).'.jpg',
                    (int)$image_type['width'], (int)$image_type['height']
                );

            }
        }
        $ret8 = $this->uploadImage($id.'_7', 'image_7', $this->fieldImageSettings['dir'].'/');
        if (($id_store = (int)Tools::getValue('$id_store')) && isset($_FILES) && count($_FILES) && $_FILES['image_7']['name'] != null && file_exists(_PS_STORE_IMG_DIR_.$id_store.'_7.jpg')) {
            $images_types = ImageType::getImagesTypes('stores');
            foreach ($images_types as $k => $image_type)
            {   
                ImageManager::resize(_PS_STORE_IMG_DIR_.$id_store.'_7.jpg',
                    _PS_STORE_IMG_DIR_.$id_store.'_7-'.stripslashes($image_type['name']).'.jpg',
                    (int)$image_type['width'], (int)$image_type['height']
                );

            }
        }
        return $ret && $ret2 && $ret3 && $ret4 && $ret5 && $ret6 && $ret7 && $ret8;
    }
