...
(function ($, window, document, undefined) {
    ...
    var Modal = function (ele, opt) {
        (this.$element = ele),
            ...
            (this.modal = $(
                '<div class="modal_window"><h2><p></p><span></span></h2><div></div><p></p>'
            )),
            (this.overlay = $('<div>'));
    };
    //定义Modal的方法
...
return false;
        ...
        hide: function () {
            ...
            this.overlay.fadeOut(settings.closeSpeed, function () {
                $(this).detach();
            });
            this.modal.fadeOut(settings.closeSpeed, function () {
                $(this).detach();
            });
        },
        version: function () {
