	...
	<ul class="footer_links clearfix">
		<li>
            <a class="btn btn-default button button-small" href="{$base_dir}">
                <span>
                    <i class="icon-long-arrow-left left"></i>&nbsp; {l s='Home'}
                </span>
            </a>
        </li>
	</ul>
...
{else}
	...
	<form action="{$request_uri|escape:'html':'UTF-8'}" method="post" class="contact-form-box animated pulse" style="visibility: visible;" enctype="multipart/form-data">
		<fieldset>
        ...
        <div class="clearfix">
            <div class="col-xs-12 col-md-3">
                <div class="form-group selector1">
                    <label for="id_contact">{l s='Subject Heading'}</label><label style="color:#951bc4;">*</label>
                ...
                {else}
					...
					<input type="hidden" id="id_contact" name="id_contact" value="1">
                ...
                {/if}
                <p class="form-group">
                    <label for="email">{l s='Email address'}</label><label style="color:#951bc4;">*</label>
                    ...
                    {if (!isset($customerThread.id_order) || $customerThread.id_order > 0)}
                        <div class="form-group selector1">
                            ...
                            {elseif $customerThread.id_order|intval > 0}
                                <input class="form-control grey" type="text" name="id_order" id="id_order" value="{$customerThread.id_order|intval}" readonly />
                            {/if}
                        </div>
                    {/if}
                    {if isset($is_logged) && $is_logged}
                        <div class="form-group selector1">
                            ...
                            {elseif $customerThread.id_product > 0}
                                <input class="form-control grey" type="text" name="id_product" id="id_product" value="{$customerThread.id_product|intval}" readonly />
                            {/if}
                        </div>
                    {/if}
                {/if}
            ...
            <div class="col-xs-12 col-md-9">
                <div class="form-group">
                    <label for="message">{l s='Message'}</label><label style="color:#951bc4;">*</label>
        ...
        <div class="submit">
            <button type="submit" name="submitMessage" id="submitMessage" class="button btn btn-default button-medium"><span><i class="icon-envelope"></i>&nbsp;&nbsp;{l s='Send'}</span></button>
		</div>
	</fieldset>
</form>
{/if}
