...
<div class="addresses clearfix">
	...
	{else}
		<a href="{$link->getPageLink('address', true, NULL, "back={$back_order_page}?step=1{'&multi-shipping=1'|urlencode}{if $back}&mod={$back}{/if}")|escape:'html':'UTF-8'}" title="{l s='Add'}" class="button button-medium btn btn-default"><span>{l s='Add a new address'} <i class="icon-plus right"></i></span></a>
	{/if}
	</p>
	<div class="row">
	...
	<p class="address_add submit">
		<a href="{$link->getPageLink('address', true, NULL, "back={$back_order_page}?step=1{'&multi-shipping=1'|urlencode}{if $back}&mod={$back|urlencode}{/if}")|escape:'html':'UTF-8'}" title="{l s='Add'}" class="button button-medium btn btn-default"><span>{l s='Add a new address'} <i class="icon-plus right"></i></span></a>
	</p>
	{if !$opc}
...
{capture}<a class="button button-medium btn btn-default" href="{$smarty.capture.addressUrlAdd}" title="{l s='Update' js=1}"><span><i class="icon-download-alt left"></i> {l s='Update' js=1}</span></a>{/capture}
