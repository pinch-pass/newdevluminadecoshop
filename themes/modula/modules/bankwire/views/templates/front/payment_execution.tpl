...
{if $nbProducts <= 0}
	<p class="alert alert-warning">
       <i class="icon-warning-sign left"></i> {l s='Your shopping cart is empty.' mod='bankwire'}
    </p>
{else}
    <form action="{$link->getModuleLink('bankwire', 'validation', [], true)|escape:'html':'UTF-8'}" method="post">
        ...
        <p class="cart_navigation clearfix" id="cart_navigation">
            ...
            href="{$link->getPageLink('order', true, NULL, "step=3")|escape:'html':'UTF-8'}" style="float:left">
                <i class="icon-long-arrow-left left"></i> {l s='Other payment methods' mod='bankwire'}
            </a>
            <button 
            class="btn btn-default button button-menu-white" 
            type="submit" style="float:right">
                <span><i class="icon-shopping-cart left"></i> {l s='I confirm my order' mod='bankwire'}</span>
            </button>
        </p>
    </form>
{/if}
