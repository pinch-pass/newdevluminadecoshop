...
<button class="usefulness_btn btn btn-default button button-medium" data-is-usefull="1" data-id-product-comment="{$comment.id_product_comment}">
<span>{l s='Yes' mod='productcomments'}</span>
</button>
<button class="usefulness_btn btn btn-default button button-medium" data-is-usefull="0" data-id-product-comment="{$comment.id_product_comment}">
...
<li>
<div class="report_btn" data-id-product-comment="{$comment.id_product_comment}">
<i class="icon icon-bullhorn"></i>&nbsp; {l s='Report abuse' mod='productcomments'}
</div>
</li>
{/if}
{/if}
...
<img  class="img-responsive" src="{$productcomment_cover_image}" height="{$mediumSize.height}" width="{$mediumSize.width}" alt="{$product->name|escape:'html':'UTF-8'}" />
