...
<ul class="lang-tabs nav nav-tabs">
    {foreach from=$htmlitems.lang.all item=lang}
		<li id="lang-{$lang.id_lang|escape:'htmlall':'UTF-8'}" class="lang-flag{if $lang.id_lang == $htmlitems.lang.default.id_lang} active{/if}"><img src="../img/l/{$lang.id_lang|escape:'htmlall':'UTF-8'}.jpg" class="pointer" alt="{$lang.name|escape:'htmlall':'UTF-8'}"/> {$lang.name|escape:'htmlall':'UTF-8'}</li>
    {/foreach}
</ul>
