...
{else}
	<p class="alert alert-warning">
		<i class="icon-warning-sign left"></i> {l s='We have noticed that there is a problem with your order. If you think this is an error, you can contact our' mod='cheque'} 
