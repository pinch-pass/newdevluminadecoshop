...
<div class="titleborder1"></div>	
	...
	{if $best_sellers && $best_sellers|@count > 0}
		<ul class="block_content products-block">
			...
			<li class="clearfix">
				...
				<div class="product-content">
                    ...
                    <p class="product-description">{$product.description_short|strip_tags:'UTF-8'|truncate:20:' ...'}</p>
                    {if !$PS_CATALOG_MODE}
                        <div class="price-box">
		...
		<div class="lnk">
        	<a href="{$link->getPageLink('best-sales')|escape:'html'}" title="{l s='All best sellers' mod='blockbestsellers'}"  class="btn btn-default button button-menu"><span>{l s='All best sellers' mod='blockbestsellers'}</span></a>
        </div>
	{else}
