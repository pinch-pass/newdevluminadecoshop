		...
		<div id="send_friend_form">
			...
			<div class="row">
				<div class="product clearfix col-xs-12 col-sm-6">
					<img class="replace-2x img-responsive" src="{$link->getImageLink($stf_product->link_rewrite, $stf_product_cover, 'home_default')|escape:'html':'UTF-8'}" height="{$homeSize.height}" width="{$homeSize.width}" alt="{$stf_product->name|escape:'html':'UTF-8'}" />
					<div class="product_desc">
						<p class="product_name">
						{$stf_product->name}
						</p>
						{$stf_product->description_short|truncate:100:' ...'}
					</div>
				</div><!-- .product -->
