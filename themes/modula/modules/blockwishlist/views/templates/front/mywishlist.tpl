...
<div id="mywishlist" class="row">
	...
	<h1 class="wishlist_h1">{l s='Избранное' mod='blockwishlist'}</h1>
		...
		{*<form method="post" class="std box" id="form_wishlist">
			<fieldset>
				...
				<p class="submit">
                    ...
                    type="submit" 
                    name="submitWishlist">
                    	<span><i class="icon-download-alt left"></i> {l s='Save' mod='blockwishlist'}</span>
                    </button>
				</p>
			</fieldset>
		</form>*}
		{if $wishlists}
			<script>WishlistManage('block-order-detail', '{$wishlists[0].id_wishlist|intval}');</script>
	...
	<ul class="footer_links clearfix">
		<li>
			<a class="btn btn-default button button-medium" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
				<span>
					<i class="icon-long-arrow-left left"></i>&nbsp; {l s='Back to Your Account' mod='blockwishlist'}
				</span>
			</a>
		</li>
		<li>
			<a class="btn btn-default button button-medium" href="{$base_dir|escape:'html':'UTF-8'}">
				<span>
					<i class="icon-long-arrow-left left"></i>&nbsp; {l s='Home' mod='blockwishlist'}
				</span>
			</a>
		</li>
	</ul>
