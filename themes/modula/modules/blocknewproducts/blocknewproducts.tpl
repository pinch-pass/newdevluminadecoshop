...
<div id="new-products_block_right" class="block newproducts_block">
...
<ul class="block_content newproducts-block">
...
<h5>
<a class="product-name" href="{$newproduct.link|escape:'html'}">{$newproduct.name|strip_tags|escape:html:'UTF-8'}</a>
</h5>



<p class="product-description">{$newproduct.description_short|strip_tags:'UTF-8'|truncate:30:' ...'}</p>
...
<div>
<a href="{$link->getPageLink('new-products')|escape:'html'}" title="{l s='All new products' mod='blocknewproducts'}" class="btn btn-default button button-menu"><span>{l s='All new products' mod='blocknewproducts'}</span></a>
</div>
