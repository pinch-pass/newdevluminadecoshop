...
{if !isset($email_create)}
	...
	<h1 class="page-heading">{l s='Sign in'}</h1>
		...
		<form action="{$link->getPageLink('authentication', true, NULL, "back=$back")|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std clearfix">
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					<h3 class="page-subheading">КОНТАКТНЫЕ ДАННЫЕ</h3>
					...
					<div class="required form-group" style="display: none">
						...
						<input type="text" class="is_required validate form-control" data-validate="isName" id="lastname" name="lastname" onblur="$('#customer_lastname').val($(this).val());" value="Неуказанная" />
						<input type="hidden" id="customer_lastname" name="customer_lastname" value="Неуказанная" />
					</div>
					...
					{if isset($newsletter) && $newsletter}
						...
						*}
					{/if}
					<h3 class="page-heading bottom-indent top-indent">Адрес</h3>
			...
			<p class="cart_navigation required submit clearfix">
				...
				<button type="submit" class="button btn btn-default button-medium" name="submitGuestAccount" id="submitGuestAccount">
					<span>
						<i class="icon-shopping-cart left"></i> {l s='Proceed to checkout'}
	...
	{/if}
	<div class="row">
		<div class="col-xs-12 col-sm-6 wow animated fadeInLeft" style="visibility: visible;">
		...
		<div class="col-xs-12 col-sm-6 wow animated fadeInRight" style="visibility: visible;">
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box">
		...
		{if isset($PS_REGISTRATION_PROCESS_TYPE) && $PS_REGISTRATION_PROCESS_TYPE}
			<div class="account_creation">
				...
				<p class="required form-group" id="address_alias" style="display:none;">
		...
		<div class="submit clearfix">
			...
			<button type="submit" name="submitAccount" id="submitAccount" class="btn btn-default button button-medium">
				<span>{l s='Register'}&nbsp;<i class="icon-long-arrow-right right"></i></span>
			</button>
