			...
			<div class="product-container" itemscope itemtype="http://schema.org/Product">
				<div class="sp-icons">
					...
					{if isset($product.new) && $product.new == 1}
						<div class="new-box">
							<img src="/themes/modula/img/new.svg" class="img-responsive">
						</div>
					{/if}
				</div>
						...
						<figure class="effect-zoe">
							<div class="product-image-container">
								...
								<a class="product_img_link"	href="{$product.link|escape:'html':'UTF-8'}" itemprop="url">
									{capture name=some_content assign=image_sizes}
		{if isset($homeSize)} width="{$homeSize.width}" height="{$homeSize.height}"{/if}
	{/capture}

	{include file="$tpl_dir./img_tag.tpl" img_url=$link->getImageLink($product.link_rewrite, $product.id_image, 'home_default')|escape:'html':'UTF-8' img_alt=$product.legend img_attributes=$image_sizes}
{*
									<img class="replace-2x img-responsive" src="{$link->
									getImageLink($product.link_rewrite, $product.id_image, 'home_default')|escape:'html':'UTF-8'}" alt="{if !empty($product.legend)}{$product.legend|escape:'html':'UTF-8'}{else}{$product.name|escape:'html':'UTF-8'}{/if}" {if isset($homeSize)} width="{$homeSize.width}" height="{$homeSize.height}"{/if} itemprop="image" />*}
								</a>

								<div class="mask">
									{if isset($product.id_image2) && $product.id_image2 != 0}
									<a class="product_img_link"	href="{$product.link|escape:'html':'UTF-8'}" itemprop="url">
										{include file="$tpl_dir./img_tag.tpl" img_url=$link->getImageLink($product.link_rewrite, $product.id_image2, 'home_default')|escape:'html':'UTF-8' img_alt=$product.legend img_attributes=$image_sizes}
{*
										<img class="replace-2x img-responsive" src="{$link->
										getImageLink($product.link_rewrite, $product.id_image2, 'home_default')|escape:'html':'UTF-8'}" alt="{$product.legend|escape:'htmlall':'UTF-8'}" {if isset($homeSize)} width="{$homeSize.width}" height="{$homeSize.height}"{/if} />*}
									</a>
									{else}
									<a class="product_img_link"	href="{$product.link|escape:'html':'UTF-8'}" itemprop="url">
										{include file="$tpl_dir./img_tag.tpl" img_url=$link->getImageLink($product.link_rewrite, $product.id_image, 'home_default')|escape:'html':'UTF-8' img_alt=$product.legend img_attributes=$image_sizes}
...
{if isset($comparator_max_item) && $comparator_max_item}
										...
										<div class="compare">
											<a href="{$product.link|escape:'html':'UTF-8'}" title="{l s='View'}"></a>
										</div>
