...
{/capture}
<div class="box">
    <h1 class="page-subheading" style="display:none">
        {l s='Your personal information'}
    </h1>
    ...
    {else}
        ...
        <form action="{$link->getPageLink('identity', true)|escape:'html':'UTF-8'}" method="post" class="std">
			...
			{/if}
                <div class="form-group">
                    <button type="submit" name="submitIdentity" class="btn btn-default button button-medium submitIdentity">
                        <span><i class="icon-download-alt left"></i> {l s='Save'}</span>
                    </button>
                </div>
...
<ul class="footer_links clearfix">
	<li>
        <a class="btn btn-default button button-medium" href="{$link->getPageLink('my-account', true)}">
            <span>
               <i class="icon-long-arrow-left left"></i>&nbsp; {l s='Back to your account'}
            </span>
        </a>
    </li>
	<li>
